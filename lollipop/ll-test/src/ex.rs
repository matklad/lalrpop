...
pub mod symbols {
    pub const foo: super::__lalrpop_util::Symbol = super::__lalrpop_util::Symbol(0);
    pub const file: super::__lalrpop_util::Symbol = super::__lalrpop_util::Symbol(1);
}
    ...
    impl fileParser {
          ...
          E:  __lalrpop_util::LrEvents,
        {
                ...
                *__last_location = __lookahead.2.clone();
                ...
                '__inner: loop {
                    ...
                    if __action > 0 {
                        ...
                        if let Some(r) = __reduce(input, events, __action, Some(&__lookahead.0), &mut __states, &mut __symbols, ::std::marker::PhantomData::<(E)>) {
                            if r.is_err() {
                                return r;
                            }
            ...
            loop {
                ...
                if __action < 0 {
                    if let Some(r) = __reduce(input, events, __action, None, &mut __states, &mut __symbols, ::std::marker::PhantomData::<(E)>) {
                        return r;
                    }
                } else {
      ...
      E:  __lalrpop_util::LrEvents,
    {
        let (__pop_states, __symbol, __nonterminal) = match -__action {
            1 => {
                ...
                let __nt = super::__action0::<E>(input, events, __sym0);
                return Some(Ok(__nt));
            }
        ...
        let __state = *__states.last().unwrap() as usize;
        let __next_state = __GOTO[__state * 1 + __nonterminal] - 1;
...
pub use self::__parsefile::fileParser;
#[cfg_attr(rustfmt, rustfmt_skip)]
mod __intern_token {
    ...
    impl __MatcherBuilder {
        pub fn new() -> __MatcherBuilder {
            ...
            let __regex_vec = vec![
                __regex::Regex::new("^((?u:\'foo\'))").unwrap(),
            ];
